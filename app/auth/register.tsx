    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.subtitle}>Set up your profile and start scanning with confidence</Text>
        </View>

        <View style={styles.card}>
          <View style={styles.switcher}>
            <Pressable style={styles.switchPill} onPress={() => router.replace('/auth/login')}>
          ...
          <View style={styles.inputWrap}>
            <Ionicons name="person-outline" size={18} color={V.textLight} />
            <TextInput
              style={styles.input}
