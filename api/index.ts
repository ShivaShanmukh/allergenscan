...
app.post('/api/scan', (req, res) => {
  ...
  const products: Record<string, any> = {
    '3017620422003': {
      name: 'Nutella Hazelnut Spread', brand: 'Ferrero',
      ingredients: 'Sugar, Palm Oil, Hazelnuts, Cocoa, Skim Milk, Whey Powder, Lecithin (Soy), Vanillin',
      allergenWarnings: [{ id: 3, name: 'Milk' }, { id: 6, name: 'Soy' }, { id: 2, name: 'Tree Nuts' }],
      safe: false, riskLevel: 'high'
    },
    '5000159484695': {
      name: 'Cadbury Dairy Milk Chocolate', brand: 'Cadbury',
      ingredients: 'Milk, Sugar, Cocoa Butter, Cocoa Mass, Vegetable Fats, Emulsifiers (Soy Lecithin)',
      allergenWarnings: [{ id: 3, name: 'Milk' }, { id: 6, name: 'Soy' }],
      safe: false, riskLevel: 'caution'
    },
    '0016000275287': {
      name: 'Organic Apple Juice', brand: 'Simply Organic',
      ingredients: 'Organic Apple Juice',
      allergenWarnings: [], safe: true, riskLevel: 'safe'
    }
  };
  ...
  if (product) {
    res.json({
      ...
      allergenWarnings: product.allergenWarnings, safe: product.safe, riskLevel: product.riskLevel
    });
  } else {
    res.json({
